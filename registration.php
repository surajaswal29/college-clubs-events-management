...
include "master.php";
      ...
      if(isset($_POST['submit'])){
        ...
        $mail = new PHPMailer(true);
          ...
          $mail->Username   = 'negiarav43@gmail.com';                     //SMTP username
          $mail->Password   = 'ybqqnjkrvfaasrtj';                               //SMTP password
          $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
          $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
      
          // Recipients
          $mail->setFrom('negiarav43@gmail.com', 'HNBGU Clubs and Socities');
...
=======
						...
						<option value="Department of Business Management">
                      		Business Management
>>>>>>> 7a0906b9112102f032416ff37e1debc8a6b63802
                      	</option>
